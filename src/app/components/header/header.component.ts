...
@Component({
  ...
  template: `
    <div class="flex justify-between items-center mb-[2rem]">
      <h1 class="font-bold text-lg text-veryLightGray tracking-[.5rem]">TODO</h1>
      <span class="hover:cursor-pointer" (click)="toggleMode()">
        @if (todoService.isDarkMod()){
...
export class HeaderComponent {
  ...
  toggleMode() {
    this.todoService.toggleDarkMode()
  }
}
